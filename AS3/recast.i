...
%typemap(astype) BuildContext*, ConvexVolume*, ConvexVolumeTool*, CrowdTool*, CrowdToolParams*, CrowdToolState*, DebugDrawGL*, dtBVNode*, dtCompressedTile*, dtCrowd*, dtCrowdAgent*, dtCrowdAgentAnimation*, dtCrowdAgentDebugInfo*, dtCrowdAgentParams*, dtCrowdNeighbour*, dtLink*, dtLocalBoundary*, dtMeshHeader*, dtMeshTile*, dtNavMesh*, dtNavMeshCreateParams*, dtNavMeshParams*, dtNavMeshQuery*, dtNode*, dtNodePool*, dtNodeQueue*, dtObstacleAvoidanceDebugData*, dtObstacleAvoidanceParams*, dtObstacleAvoidanceQuery*, dtObstacleCircle*, dtObstacleSegment*, dtOffMeshConnection*, dtPathCorridor*, dtPathQueue*, dtPoly*, dtPolyDetail*, dtProximityGrid*, dtQueryFilter*, dtTileCache*, dtTileCacheAlloc*, dtTileCacheCompressor*, dtTileCacheContour*, dtTileCacheContourSet*, dtTileCacheLayer*, dtTileCacheLayerHeader*, dtTileCacheMeshProcess*, dtTileCacheObstacle*, dtTileCacheParams*, dtTileCachePolyMesh*, duDebugDraw*, duDisplayList*, duFileIO*, FileIO*, FileList*, GraphParams*, imguiGfxCmd*, imguiGfxLine*, imguiGfxRect*, imguiGfxText*, InputGeom*, NavMeshPruneTool*, NavMeshTesterTool*, OffMeshConnectionTool*, rcChunkyTriMesh*, rcChunkyTriMeshNode*, rcCompactCell*, rcCompactHeightfield*, rcCompactSpan*, rcConfig*, rcContext*, rcContour*, rcContourSet*, rcHeightfield*, rcHeightfieldLayer*, rcHeightfieldLayerSet*, rcIntArray*, rcMeshLoaderObj*, rcPolyMesh*, rcPolyMeshDetail*, rcSpan*, rcSpanPool*, Sample*, Sample_Debug*, Sample_SoloMesh*, Sample_TempObstacles*, Sample_TileMesh*, SampleTool*, SampleToolState*, SlideShow*, TestCase*, ValueHistory*, 
BuildContext&, ConvexVolume&, ConvexVolumeTool&, CrowdTool&, CrowdToolParams&, CrowdToolState&, DebugDrawGL&, dtBVNode&, dtCompressedTile&, dtCrowd&, dtCrowdAgent&, dtCrowdAgentAnimation&, dtCrowdAgentDebugInfo&, dtCrowdAgentParams&, dtCrowdNeighbour&, dtLink&, dtLocalBoundary&, dtMeshHeader&, dtMeshTile&, dtNavMesh&, dtNavMeshCreateParams&, dtNavMeshParams&, dtNavMeshQuery&, dtNode&, dtNodePool&, dtNodeQueue&, dtObstacleAvoidanceDebugData&, dtObstacleAvoidanceParams&, dtObstacleAvoidanceQuery&, dtObstacleCircle&, dtObstacleSegment&, dtOffMeshConnection&, dtPathCorridor&, dtPathQueue&, dtPoly&, dtPolyDetail&, dtProximityGrid&, dtQueryFilter&, dtTileCache&, dtTileCacheAlloc&, dtTileCacheCompressor&, dtTileCacheContour&, dtTileCacheContourSet&, dtTileCacheLayer&, dtTileCacheLayerHeader&, dtTileCacheMeshProcess&, dtTileCacheObstacle&, dtTileCacheParams&, dtTileCachePolyMesh&, duDebugDraw&, duDisplayList&, duFileIO&, FileIO&, FileList&, GraphParams&, imguiGfxCmd&, imguiGfxLine&, imguiGfxRect&, imguiGfxText&, InputGeom&, NavMeshPruneTool&, NavMeshTesterTool&, OffMeshConnectionTool&, rcChunkyTriMesh&, rcChunkyTriMeshNode&, rcCompactCell&, rcCompactHeightfield&, rcCompactSpan&, rcConfig&, rcContext&, rcContour&, rcContourSet&, rcHeightfield&, rcHeightfieldLayer&, rcHeightfieldLayerSet&, rcIntArray&, rcMeshLoaderObj&, rcPolyMesh&, rcPolyMeshDetail&, rcSpan&, rcSpanPool&, Sample&, Sample_Debug&, Sample_SoloMesh&, Sample_TempObstacles&, Sample_TileMesh&, SampleTool&, SampleToolState&, SlideShow&, TestCase&, ValueHistory&
 "int /**< {$*1_ltype} */";
