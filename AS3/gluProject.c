...
void MultiplyMatrices4by4OpenGL_GLdouble(GLdouble *result, const GLdouble *matrix1, const GLdouble *matrix2);
int gluInvertMatrixf2(GLdouble *m, GLdouble *out);
...
GLAPI GLint GLAPIENTRY gluProject (GLdouble objx, GLdouble objy, GLdouble objz, const GLdouble *modelview, const GLdouble *projection, const int *viewport, GLdouble* winX, GLdouble* winY, GLdouble* winZ)
{
...
GLAPI GLint GLAPIENTRY gluUnProject(GLdouble winx, GLdouble winy, GLdouble winz, const GLdouble *modelview, const GLdouble *projection, const GLint *viewport, GLdouble* objX, GLdouble* objY, GLdouble* objZ)
{
