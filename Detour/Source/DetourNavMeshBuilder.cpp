						...
						const int /*nnodes*/, dtBVNode* nodes)
{
	...
	for (int i = 0; i < npolys; i++)
	{
		...
		// Remap y
		it.bmin[1] = (unsigned short)dtMathFloorf((double)it.bmin[1]*ch/cs);
		it.bmax[1] = (unsigned short)dtMathCeilf((double)it.bmax[1]*ch/cs);
	}
...
bool dtNavMeshDataSwapEndian(unsigned char* data, const int /*dataSize*/)
{
	...
	double* verts = (double*)d; d += vertsSize;
	...
	double* detailVerts = (double*)d; d += detailVertsSize;
